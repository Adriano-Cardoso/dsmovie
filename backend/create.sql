create table tb_movie (movie_id int8 generated by default as identity, count int4, image varchar(255), score float8, title varchar(255), primary key (movie_id));
create table tb_score (value float8, movie_id int8 not null, user_id int8 not null, primary key (movie_id, user_id));
create table tb_user (video_id int8 generated by default as identity, email varchar(255), primary key (video_id));
